...
net2.Add(net1.Get(0))                                          # Adding r to n2
net2.Add(n1)
...
# allnet  =  ns.network.NodeContainer(net1, net2) # allnet is like all in cpp program
# dall = csma.Install(allnet)


print "Create IPv6 Internet Stack"
internetv6 = ns.internet.InternetStackHelper()
internetv6.Install(net1)
internetv6.Install(net2.Get(1))
