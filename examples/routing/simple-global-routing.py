...
def main (argv):
	...
	c.Create (4)
	n0n2 = ns.network.NodeContainer (c.Get (0))
        n0n2.Add(c.Get(2))
	n1n2 = ns.network.NodeContainer (c.Get (1))
        n1n2.Add(c.Get(2))
	n3n2 = ns.network.NodeContainer (c.Get (3))
        n3n2.Add(c.Get(2))
	...
	onoff.SetAttribute ("Remote", ns.network.AddressValue(ns.network.InetSocketAddress (i1i2.GetAddress (0), port)))
